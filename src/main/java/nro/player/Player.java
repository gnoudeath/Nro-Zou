...
//    public Item itemPet2 = null;
    ...
    public boolean isPet3 = false;
    public byte pet3Follow = 0;
    ...
    public boolean isPorata2 = false;
     public int checklixi = 0;
     public int checktanthu =0;
...
//    public Timer setSession = null;
    ...
    public int pointnew =0;
    public int event_ltn = 0;
    public int diemsukien =0;
    public Player() {
        this.ItemBag = null;
        this.ItemBody = null;
        this.ItemBox = null;
    ...
    public short PartHead() {
        ...
        if(NhapThe == 1 && gender == (byte)1){
            if(this.ItemBody[5] != null && ((this.ItemBody[5].template.id >= 601 && this.ItemBody[5].template.id <= 603) || (this.ItemBody[5].template.id >= 639 && this.ItemBody[5].template.id <= 641) || (ItemBody[5].template.id >= 1146 && ItemBody[5].template.id != 1147 && ItemBody[5].template.id <= 1149))) {
...
&& this.ItemBody[5].template.id != 639 && this.ItemBody[5].template.id != 640 && this.ItemBody[5].template.id != 641 && this.ItemBody[5].template.id != 1146 && this.ItemBody[5].template.id != 1148 && this.ItemBody[5].template.id != 1149)) {
    ...
    public short iconIDHead() {
        if(NhapThe == 1 && gender == (byte)1){
            if(this.ItemBody[5] != null && ((this.ItemBody[5].template.id >= 601 && this.ItemBody[5].template.id <= 603) || (this.ItemBody[5].template.id >= 639 && this.ItemBody[5].template.id <= 641) || (this.ItemBody[5].template.id >= 1146 && this.ItemBody[5].template.id != 1147 && this.ItemBody[5].template.id <= 1149))) {
...
&& this.ItemBody[5].template.id != 639 && this.ItemBody[5].template.id != 640 && this.ItemBody[5].template.id != 641 && this.ItemBody[5].template.id != 1146 && this.ItemBody[5].template.id != 1148 && this.ItemBody[5].template.id != 1149)) {
    ...
    public int getHpFull() {
        ...
        if(ItemBody[5] != null){
            if((ItemBody[5].template.id >= 601 && ItemBody[5].template.id <= 603) || (ItemBody[5].template.id >= 639 && ItemBody[5].template.id <= 641) || (ItemBody[5].template.id >= 1146 && ItemBody[5].template.id != 1147 && ItemBody[5].template.id <= 1149)) { //CAI TRANG HOP THE
                if(this.NhapThe == 1) {
                ...
                hp += (int)(hp*Util.getPercentDouble(ItemBody[5].getParamItemByID(77)));
                if(ItemBody[5].template.id == 883) {
                    hp += (int)(hp*Util.getPercentDouble(ItemBody[5].getParamItemByID(172)));    
                }
            }
        }
        if(ItemBody[6] != null){
        ...
        if(this.pet3Follow  == 1 && this.pet != null && this.ItemBody[7] != null) {
            hp += (int)(hp*Util.getPercentDouble(ItemBody[7].getParamItemByID(77)));
        }
        //RADA CARD
        hp += hpRada;
    ...
    public int getMpFull() {
        ...
        if(ItemBody[5] != null){
            if((ItemBody[5].template.id >= 601 && ItemBody[5].template.id <= 603) || (ItemBody[5].template.id >= 639 && ItemBody[5].template.id <= 641) || (ItemBody[5].template.id >= 1146 && ItemBody[5].template.id != 1147 && ItemBody[5].template.id <= 1149)) { //CAI TRANG HOP THE
                ...
                mp += (int)(mp*Util.getPercentDouble(ItemBody[5].getParamItemByID(103))); //caitrang
                if(ItemBody[5].template.id == 898) {
                    mp += (int)(mp*Util.getPercentDouble(ItemBody[5].getParamItemByID(105)));    
                }
            }
        }
        if(ItemBody[6] != null){
        ...
        if(this.timeEndNRSD[(byte)2] > System.currentTimeMillis()) {
            mp = (int)(mp*1.3);
        }
        //OPTION PORATA 2
        if(this.NhapThe == 1 && this.isPorata2) {
                    ...
                    for (int i=0; i< PlayerManger.gI().conns.size(); i++) {
                        if(PlayerManger.gI().conns.get(i) != null && PlayerManger.gI().conns.get(i).player != null) {
                            ...
                            if(player != null && player.map == map){
                                player.zone.chat(player, "Bunma ngon vãi òn\nTrông Lứng thật sự");
                            }
                        }
                    }
                }
    ...
    public int getDamFull() {
        ...
        if(ItemBody[5] != null){
            if((ItemBody[5].template.id >= 601 && ItemBody[5].template.id <= 603) || (ItemBody[5].template.id >= 639 && ItemBody[5].template.id <= 641) || (ItemBody[5].template.id >= 1146 && ItemBody[5].template.id != 1147 && ItemBody[5].template.id <= 1149)) { //CAI TRANG HOP THE
                ...
                dam += (int)(dam*Util.getPercentDouble(ItemBody[5].getParamItemByID(50)));
                if(ItemBody[5].template.id == 860 || ItemBody[5].template.id == 584 || ItemBody[5].template.id == 1103 || ItemBody[5].template.id == 1149 || ItemBody[5].template.id == 1146|| ItemBody[5].template.id == 1148) {
                    dam += (int)(dam*Util.getPercentDouble(ItemBody[5].getParamItemByID(117)));    
                    dam += (int)(dam*Util.getPercentDouble(ItemBody[5].getParamItemByID(217)));
                }
            }
        }
        if(ItemBody[6] != null){
...
//        }
    ...
    public byte getCritFull() {
        ...
        if(this.timeEndNRSD[(byte)6] > System.currentTimeMillis()) {
            crit = 10;
        }
        return crit;
    }
...
//        System.out.println("QUANTITY ITEM BUY : " + item.quantityTemp);
        try {
            ...
            //     }
                ...
                return true;
            } else if(item.isItemBackground() && item.template.id != 822) {
                index = this.getIndexBagNotItem();
                ...
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 10) {
                    if (getBagNull() == 0) {
                        ...
                        _item.itemOptions.add(new ItemOption(77, Util.nextInt(10, 26)));
                        _item.itemOptions.add(new ItemOption(103, Util.nextInt(10, 26)));
                        _item.itemOptions.add(new ItemOption(14, Util.nextInt(1, 16)));
                        int day = Util.nextInt(1, 16);
                ...
                return true;
            } else if(item.template.id == 648) { //HOP QUA NOEL
                index = this.getIndexBagNotItem();
//                byte indexMedal = getIndexItemByIdAndQuantiy(649, 1); //id = 649: tat noel
//                if(this.ItemBag[indexMedal].quantity >= 1) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
//                        this.ItemBag[indexMedal].quantity -= 1;
//                        if(this.ItemBag[indexMedal].quantity <= 0) {
//                            this.ItemBag[indexMedal] = null;
//                        }
...
//                } else {
//                    this.sendAddchatYellow("Cần 1 Tất Noel để nhận hộp quà!");
//                    return false;
//                }
                return true;
            } else if(item.template.id == 1168 ||item.template.id ==    1165 ||item.template.id ==    1166) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 30); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 30) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 30;
                        if(this.ItemBag[indexMedal].quantity <= 30) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                        _item.quantity = 1;
                    ...
                    this.sendAddchatYellow("Cần 30 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 473) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 25); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 25) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 25;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 25 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 472) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 20); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 20) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 20;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 20 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 466) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 15); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 15) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 15;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 15 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 465) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 10); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 10) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    ...
                    this.sendAddchatYellow("Cần 10 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 722) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 5); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 5) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 5;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 5 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id == 1106 ||item.template.id ==    1104 ||item.template.id ==    1105) {//cải trang
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 199); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 199) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 199;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 199 thỏi vàng để mua!");
                    return false;
                }
                return true;
            } else if(item.template.id ==  1103) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 3999); //id = 457: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 399) {
                    if (getBagNull() == 0) {
                        this.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                        return false;
                    } else {
                        //TRU thoi vang di
                        this.ItemBag[indexMedal].quantity -= 3999;
                        if(this.ItemBag[indexMedal].quantity <= 0) {
                            this.ItemBag[indexMedal] = null;
                        }
                         Item _item = new Item(item);
                    ...
                    this.sendAddchatYellow("Cần 3999 thỏi vàng để mua!");
                    return false;
                    
                }
                return true;
            } else if(item.template.id == 1101) {
                index = this.getIndexBagNotItem();
                byte indexMedal = getIndexItemByIdAndQuantiy(457, 10); //id = 979: thoi vang
                if(indexMedal != -1 && this.ItemBag[indexMedal].quantity >= 10) {
                    if (getBagNull() == 0) {
                ...
                if(countLeft > 0) {
                    ...
                    if (getBagNull() == 0) {
                        ...
                        if(item.id == 649) {
                            point += 10;
                            totalPoint += 10;
                        } else if(item.id >= 386 && item.id <= 394) {
                            _item.timeHSD = System.currentTimeMillis() + 864000000;
                        }
                        this.ItemBag[index2] = _item;
                        return true;
                    }
    ...
    public void itemBagToBox(int index){
        ...
        if(item != null){
            ...
            //     if(indexBox != -1) {
            //         int countLeft = this.ItemBox[indexBox].quantity - 998;
            //         if(countLeft > 0) {
            ...
            //             } else {
            //                 removeItemBag(index);
            //                 if(this.ItemBox[indexBox].quantity < 999) {
            ...
            else if (indexBox != -1 && (item.template.type == 6 || item.template.type == 12 || item.template.type == 14 || item.template.type == 15
            || item.template.type == 16 || item.template.type == 22 || item.template.type == 23 || item.template.type == 24 || item.template.type == 25 || item.template.type == 27 ||
            item.template.type == 29 || item.template.type == 30 || item.template.type == 31 || item.template.type == 33)) {
            if (item.template.id == 457) {
                // Handle item 457: always add to existing quantity without limit
                if (ItemBox[indexBox].template.id == 457) {
                    ItemBox[indexBox].quantity += item.quantity;
                } else {
                    Item _item = new Item(item);
                    this.ItemBox[indexBox] = _item;
                }
...
//            item.quantity = item.quantityTemp;
    ...
    public void itemBoxToBag(int index) {
        ...
        if(item != null){
            ...
            if (indexBag != -1 && ( item.template.type == 6 || item.template.type == 12 || item.template.type == 14 || item.template.type == 15
                || item.template.type == 16 || item.template.type == 22 || item.template.type == 23 || item.template.type == 24 || item.template.type == 25 || item.template.type == 27 || 
                item.template.type == 29 || item.template.type == 30 || item.template.type == 31 || item.template.type == 33)) {
    ...
    public void itemBodyToBag(int index) { 
        ...
        if(_item != null){
            ...
            if(index == 7 && this.ItemBody[index] != null && this.ItemBody[index].id == _item.id) {
                ...
                this.pet = null;
            } else if(index == 7 && this.ItemBody[index] != null && this.ItemBody[index].id == _item.id) {
                this.pet3Follow = (byte)0;
                zone.leavePETTT(this.pet);
                this.pet = null;
            }
...
//            System.out.println("ismonkey body to bag: " + this.isMonkey);
    ...
    public void itemBagToBodyPet(byte index) throws IOException {
        ...
        //        this.detu.head = this.detu.PartHead();
            ...
            sendAddchatYellow("Bớt ngu đi? 1tr5 thì mặc được!");
        }
    }
...
//            }
    ...
    public int getPercentHutHp() {
        ...
        if(this.timeEndNRSD[(byte)4] > System.currentTimeMillis()) {
            _percent += 30;
        }
        return _percent;
    }
    ...
    public int getPercentPST() {
        ...
        if(this.timeEndNRSD[(byte)3] > System.currentTimeMillis()) {
            _percent += 30;
        }
        return _percent;
    }
    ...
    //GET % phan sat thuong
    public int getPercentSTCRIT() {
        int _percent = 0;
        if(ItemBody[5] != null){
            _percent += ItemBody[5].getParamItemByID(5); //spl pst
        }
        return _percent;
    }
    // GET DAME CAI TRANG
        ...
        if(this.ItemBody[0] != null && this.ItemBody[1] != null && this.ItemBody[2] != null && this.ItemBody[3] != null && this.ItemBody[4] != null) {
            ...
            for(byte i = 0; i < this.ItemBody[0].itemOptions.size(); i++) {
                if(this.ItemBody[0].itemOptions.get(i).id == 127 || this.ItemBody[0].itemOptions.get(i).id == 128 || this.ItemBody[0].itemOptions.get(i).id == 129
                   || this.ItemBody[0].itemOptions.get(i).id == 130 || this.ItemBody[0].itemOptions.get(i).id == 131 || this.ItemBody[0].itemOptions.get(i).id == 132|| this.ItemBody[0].itemOptions.get(i).id == 215
    ...
    public boolean chkRadaSetKichHoat(Item item) {
        ...
        for(byte i = 0; i < item.itemOptions.size(); i++) {
            if((item.itemOptions.get(i).id == 127 || item.itemOptions.get(i).id == 128 || item.itemOptions.get(i).id == 129 ||
                item.itemOptions.get(i).id == 130 || item.itemOptions.get(i).id == 131 || item.itemOptions.get(i).id == 132 ||item.itemOptions.get(i).id == 215 ||
            ...
            if((item.itemOptions.get(i).id == 127 || item.itemOptions.get(i).id == 128 || item.itemOptions.get(i).id == 129) && this.detu.gender == (byte)0) {
                return true;
            } else if((item.itemOptions.get(i).id == 130 || item.itemOptions.get(i).id == 131 || item.itemOptions.get(i).id == 132|| item.itemOptions.get(i).id == 215) && this.detu.gender == (byte)1) {
                return true;
...
//                    Map map = Manager.getMapid(rs.getByte("where_id"));
                    ...
                    player.checklixi = rs.getInt("checklixi");
                    player.checktanthu = rs.getInt("checktanthu");
                    player.tSwapZone = System.currentTimeMillis() + 14000;
                    player.point = rs.getInt("event_point");
                    player.totalPoint = rs.getInt("total_point");
                    player.pointnew = rs.getInt("event_pointnew");
...
//                                player.detu.skill.add(skillpet);
    ...
    public boolean checkCTCold() {
        ...
        || ItemBody[5].template.id == 878 || ItemBody[5].template.id == 827 || ItemBody[5].template.id == 386 || ItemBody[5].template.id == 387 || ItemBody[5].template.id == 388 || ItemBody[5].template.id == 399 || ItemBody[5].template.id == 390 || ItemBody[5].template.id == 391 || ItemBody[5].template.id == 392 || ItemBody[5].template.id == 1118 || ItemBody[5].template.id == 394 || ItemBody[5].template.id == 612 || ItemBody[5].template.id == 613 || ItemBody[5].template.id == 614 || ItemBody[5].template.id == 879 || ItemBody[5].template.id == 937)) {
            return true;
        }
        return false;
    }
    ...
    public byte getIndexDoThanLinh(int id) {
        int idItem = -1;
        if(id == 650) {
            idItem = 555;
        } else if(id == 652) {
        ...
        if(idItem != -1) {
            for(byte i = 0; i < this.ItemBag.length; i++) {
                if (this.ItemBag[i] != null && this.ItemBag[i].template.id == idItem && this.ItemBag[i].quantity >= 1) {
                    return i;
                }
            }
        }
    ...
    //CHECK FULL SET HUY DIET
    public boolean checkFullHuyDiet() {
        if(this.ItemBody[0] != null && this.ItemBody[1] != null && this.ItemBody[2] != null && this.ItemBody[3] != null && this.ItemBody[4] != null) {
            if(this.ItemBody[0].template.level == (byte)14 && this.ItemBody[1].template.level == (byte)14 && this.ItemBody[2].template.level == (byte)14 
            && this.ItemBody[3].template.level == (byte)14 && this.ItemBody[4].template.level == (byte)14) {
                return true;
            }
        }
        return false;
    ...
    // Check full mành thiên sứ
    public boolean check9999Manhthiensu() {
        for (Item item : this.ItemBag) {
            if (item != null && item.template.id >= 1139 && item.template.id <= 1143 && item.quantity == 9999) {
                return true;
            }
        }
        return false;
    ...
    //CHECK FULL SET THIEN SU
    public boolean checkFullSetThienSu() {
        if(this.ItemBody[0] != null && this.ItemBody[1] != null && this.ItemBody[2] != null && this.ItemBody[3] != null && this.ItemBody[4] != null) {
            if(this.ItemBody[0].template.level == (byte)15 && this.ItemBody[1].template.level == (byte)15 && this.ItemBody[2].template.level == (byte)15 
            && this.ItemBody[3].template.level == (byte)15 && this.ItemBody[4].template.level == (byte)15) {
                return true;
            }
        }
        return false;
