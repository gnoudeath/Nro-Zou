...
public class Service {
    ...
    public void LoadDeTu(Player p, byte type){
        ...
        if(p.detu == null) {
            p.sendAddchatYellow("bạn gà vcl nạp tiền đi bạn");
            return;
        }
        try {
            m = new Message(-107);
    ...
    public void MagicTree(Player player, byte type) {
        ...
        try {
            ...
            if(type == (byte)0){
                ...
                long timeMax = (long)(player.maxBean*player.levelTree*600000);
...
//                    m.writer().writeInt(Server.gI().menu.timeUpMagicTree(player.levelTree));
    ...
    public void loginDe(Session session, int second) {
        Message msg;
        try {
            msg = new Message(122);
...
//            msg.writer().writeByte(15);
            ...
            msg.writer().writeLong(120010000000L);
...
//            msg.writer().write(FileIO.readFile("res/cache/v221/head"));
         //   ByteArrayInputStream is = new ByteArrayInputStream(FileIO.readFile("res/cache/vhalloween/head"));
           ByteArrayInputStream is = new ByteArrayInputStream(FileIO.readFile("res/cache/head"));
            DataInputStream dis = new DataInputStream(is);
            short lengthHead = dis.readShort();
//            msg.writer().writeShort(lengthHead);
                   msg.writer().writeShort(lengthHead + 26);
...
//            msg.writer().writeShort((short)289); //v221
            for(short i = 0; i < lengthHead; i++) {
             ...
             //cumber 25
            msg.writer().writeShort((short) 553);
            msg.writer().writeShort((short) 6101);
            //cumber 24
            msg.writer().writeShort((short) 1252);
            msg.writer().writeShort((short) 11471);
                //cumber 23
            msg.writer().writeShort((short) 1249);
            msg.writer().writeShort((short) 11439);
                //cumber 22
            msg.writer().writeShort((short) 1246);
            msg.writer().writeShort((short) 11407);
            
               //cumber 18
            msg.writer().writeShort((short) 1243);
            msg.writer().writeShort((short) 11074);
               //cumber 18
            msg.writer().writeShort((short) 1240);
            msg.writer().writeShort((short) 11074);//cumber 18
            msg.writer().writeShort((short) 1237);
            msg.writer().writeShort((short) 11074);
             //cumber 18
            msg.writer().writeShort((short) 1234);
            msg.writer().writeShort((short) 11282);
            
             //cumber 17
            msg.writer().writeShort((short) 1231);
            msg.writer().writeShort((short) 11074);
             //cumber 16
            msg.writer().writeShort((short) 1228);
            msg.writer().writeShort((short) 11074);
            
             //cumber 15
            msg.writer().writeShort((short) 1204);
            msg.writer().writeShort((short) 11176);
            //cumber 14
            msg.writer().writeShort((short) 1225);
            msg.writer().writeShort((short) 11021);
            //cumber
            msg.writer().writeShort((short) 1219);
            msg.writer().writeShort((short) 10948);
            //cumber
            msg.writer().writeShort((short) 1222);
            msg.writer().writeShort((short) 10988);
            //cumber
            msg.writer().writeShort((short) 1216);
            msg.writer().writeShort((short) 11054);
            //cumber
            msg.writer().writeShort((short) 1213);
            msg.writer().writeShort((short) 11137);
            //cumber
            msg.writer().writeShort((short) 1210);
            msg.writer().writeShort((short) 11138);
            //cumber
            msg.writer().writeShort((short) 1207);
            msg.writer().writeShort((short) 11250);
...
//                m.writer().writeShort(2330);
    ...
    public void petLiveFromDead(Player _player) {
        _player.zone.chat(_player.detu, "Ê nhók anh đến rồi đây");
        Message m = null;
        try {
    ...
    public void SendPetLiveFromDead(Player _player) {
        _player.zone.chat(_player.detu, "vl luôn đầu cắt moi!");
        Message m = null;
        try {
            _player.detu.hp = _player.detu.getHpFull();
            _player.detu.mp = _player.detu.getMpFull();
        ...
        TimerTask tt = new TimerTask() {
            public void run()
            {
                if(p.detu != null && p.detu.isdie) {
                    ...
                    p.petfucus = 1;
                    LoadDeTuFollow(p, 1);
                    p.zone.chat(p.detu, "hê sờ lô li lis!");
        ...
        if(_itemUp.template.type != 0 && _itemUp.template.type != 1 && _itemUp.template.type != 2 && _itemUp.template.type != 3 && _itemUp.template.type != 4 && _itemUp.template.type != 32) {
            ...
            if((System.currentTimeMillis() - _player._timeDapDo) >= 1000 && _player._checkDapDo) {
                ...
                if(_itemUp != null && (_player.vang >= (_itemUp.getGoldUpStar(_itemUp._starItem)*1000000L) ) && (_player.ngoc >= (_itemUp._starItem + 1) ) && (_itemUp.getParamItemByID(107) < 8)) {
                    ...
                    int rdUp = Util.nextInt(0, 200);
                    if (_itemUp._starItem == 6) {
                        rdUp = Util.nextInt(0, 1000);
                    } else if (_itemUp._starItem == 7) {
                        rdUp = Util.nextInt(0, 2000);
                    } else if (_itemUp._starItem == 5) {
...
//            Util.log("INFOOOOOOOOOOOOOOOOO: " + _info);
            ...
            try {
                ...
                if(_player.vang >= _item.getGoldUpItem(lvItem)) {
                    ...
                    m.writer().writeUTF("Nâng cấp bằng bùa");
                    m.writer().writeUTF("Từ chối");
                } else {
                    m.writer().writeByte(1);
    ...
    public void sendUpLevelItem100(Player _player) {
        Item _itemUp = _player._itemUpStar;
        Item _stone = _player._itemUseEpStar;
        if(_itemUp == null || _stone == null) {
            return;
        }
        int bnc = _player.getIndexItemBagByID(1144);
                                if(bnc != -1 && _player.ItemBag[bnc].quantity >= 1) {_player.ItemBag[bnc].quantity -= 1;
                                    if(_player.ItemBag[bnc].quantity <= 0) {
                                        _player.ItemBag[bnc] = null;
                                    }
                                    
                                    Service.gI().updateItemBag(_player);}else{return;}
        Item _daBaoVe = null;
        ...
        if((System.currentTimeMillis() - _player._timeDapDo) >= 1000 && _player._checkDapDo) {
            ...
            if(_itemUp != null && _stone != null && (_player.vang >= (_itemUp.getGoldUpItem(_itemUp._levelItem)*1000) ) && (_player.ItemBag[_player._indexEpStar].quantity >= _itemUp.getCountStoneUpItem(_itemUp._levelItem) ) ) {
                ...
                if(_stone.id == 222|| _stone.id == 220 || _stone.id == 221 || _stone.id == 223|| _stone.id == 224){rdUp=1;}
            ...
            if(_itemUp != null && _manhHon != null && _daXLam != null && (_player.ngoc >= 2500) && (_player.ItemBag[_player._indexEpStar].quantity >= 99) && (_player.ItemBag[_player._indexEpStar2].quantity >= 1) ) {
                ...
                if(rdUp <= 49) {
                    ...
                    if(_player.ItemBag[_player._indexUpStar].template.id == 921) {
                        ...
                        if(rdUp == 0) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(50, Util.nextInt(5, 21)));
                        } else if(rdUp == 1) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(77, Util.nextInt(5, 21)));
                        } else if(rdUp == 2) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(103, Util.nextInt(5, 21)));
                        } else if(rdUp == 3) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(108, Util.nextInt(5, 21)));
                        } else if(rdUp == 4) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(94, Util.nextInt(5, 16)));
                        } else if(rdUp == 5) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(14, Util.nextInt(2, 16)));
                        } else if(rdUp == 6) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(80, Util.nextInt(5, 21)));
                        } else if(rdUp == 7) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(81, Util.nextInt(5, 21)));
                        } else if(rdUp == 8) {
                            _player.ItemBag[_player._indexUpStar].itemOptions.add(new ItemOption(175, Util.nextInt(5, 21)));
                        }
                    }
                    sendUpStarSuccess(_player);
                } else {
...
//        if(_item.template.id >= 15 && _item.template.id <=20) { //2s den 7s
            ...
            Service.gI().serverMessage(_player.session, "Chỉ được phép ép ngọc rồng từ 2 đến 7 sao!");
        }
    }
...
//        Boss _Androi20 = new Boss(130, (byte)19, xA20, yA19);
...
//        Boss _Androi14 = new Boss(131, (byte)11, (short)235, (short)336);
//        Boss _Androi13 = new Boss(132, (byte)22, (short)277, (short)336);
...
//        Util.log("INIT _Chilled XONG MAP " + Server.gI().maps[159].template.name + ", " + IDZONE);
    ...
    public void initCumBer() {
        int IDZONE = Util.nextInt(0, Server.gI().maps[151].area.length);
        Boss _CumBer = new Boss(535, (byte)55, (short)982, (short)336);

        Server.gI().maps[151].area[IDZONE].bossMap.add(_CumBer);
        Server.gI().maps[151].area[IDZONE].loadBossNoPet(_CumBer);
        sendThongBaoServer("BOSS " + _CumBer.name + " vừa xuất hiện tại " + Server.gI().maps[151].template.name);
//        Util.log("INIT _CumBer XONG MAP " + Server.gI().maps[151].template.name + ", " + IDZONE);
    }
...
//        Util.log("INIT ZAMASU XONG MAP " + Server.gI().maps[97].template.name + ", " + IDZONE);
    ...
    public void initCoolerGold() {
        int IDZONE = Util.nextInt(0, Server.gI().maps[6].area.length);
        Boss _CoolerGold = new Boss(532, (byte)52, (short)1335, (short)192);

        Server.gI().maps[111].area[IDZONE].bossMap.add(_CoolerGold);
        Server.gI().maps[111].area[IDZONE].loadBossNoPet(_CoolerGold);
        sendThongBaoServer("BOSS " + _CoolerGold.name + " vừa xuất hiện tại " + Server.gI().maps[6].template.name);
        Util.log("INIT COOLERGOLD XONG MAP " + Server.gI().maps[6].template.name + ", " + IDZONE);
    }
    public void initFideGold() {
        int IDZONE = Util.nextInt(0, Server.gI().maps[24].area.length);
        Boss _FideGold = new Boss(534, (byte)54, (short)1335, (short)192);

        Server.gI().maps[24].area[IDZONE].bossMap.add(_FideGold);
        Server.gI().maps[24].area[IDZONE].loadBossNoPet(_FideGold);
        sendThongBaoServer("BOSS " + _FideGold.name + " vừa xuất hiện tại " + Server.gI().maps[24].template.name);
        Util.log("INIT FIDEGOLD XONG MAP " + Server.gI().maps[24].template.name + ", " + IDZONE);
    }
    public void initBillWhis() {
        int idMap = Util.nextInt(0, 3);
        short xBill = (short)288;
        short yWish = (short)354;
        if(idMap == 0) {
            idMap = 42;
        } else if(idMap == 1) {
            idMap = 43;
        ...
        Server.gI().maps[idMap].area[IDZONE].bossMap.add(_Bill);
        Server.gI().maps[idMap].area[IDZONE].loadBossNoPet(_Bill);
        sendThongBaoServer("BOSS " + _Bill.name + " vừa xuất hiện tại " + Server.gI().maps[idMap].template.name);
        Boss _Whis = new Boss(530, (byte)50, (short)305, (short)288);
        Server.gI().maps[idMap].area[IDZONE].bossMap.add(_Whis);
        Server.gI().maps[idMap].area[IDZONE].loadBossNoPet(_Whis);
        sendThongBaoServer("BOSS " + _Whis.name + " vừa xuất hiện tại " + Server.gI().maps[idMap].template.name);
//        Util.log("INIT initBillWhis XONG MAP " + Server.gI().maps[idMap].template.name + ", " + IDZONE);
    }
    public void initSuperZou() {
        int idMap = Util.nextInt(0, 3);
        short xSuperZou = (short)379;
        if(idMap == 0) {
            idMap = 6;
        } else if(idMap == 1) {
            idMap = 10;
        ...
        int IDZONE = Util.nextInt(0, Server.gI().maps[idMap].area.length);
        Boss _SuperZou = new Boss(531, (byte)51, (short)379, (short)456);

        Server.gI().maps[idMap].area[IDZONE].bossMap.add(_SuperZou);
        Server.gI().maps[idMap].area[IDZONE].loadBossNoPet(_SuperZou);
        sendThongBaoServer("BOSS " + _SuperZou.name + " vừa xuất hiện tại " + Server.gI().maps[idMap].template.name);
//        Util.log("INIT SuperZou XONG MAP " + Server.gI().maps[idMap].template.name + ", " + IDZONE);
    }
    //NGOC RONG SAO DEN
...
//        calendar.set(Calendar.HOUR_OF_DAY, 20); //SERVER 2
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);
        calendar.set(Calendar.MILLISECOND, 0);
        Date dateSchedule = calendar.getTime();
    ...
    public void initMabu12h() {
        ...
        TimerTask Mabu = new TimerTask() {
            public void run()
            {
                ...
                timerEndMabu.schedule(endMabu, 7200000);
            };
        };
...
//        calendar.set(Calendar.HOUR_OF_DAY, 12); //SERVER 2
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);
        calendar.set(Calendar.MILLISECOND, 0);
        Date dateSchedule = calendar.getTime();
...
//            Util.log("CUPTIME GLT: " + p.ItemBody[6].cUpTimeGLT + ", TIME: " + p.ItemBody[6].timeGLT);
    ...
    public boolean checkTaskGoMap(Player p, int mapid) {
        if(p.taskId < (short)8 && ((mapid >= 45 && mapid <= 50) || mapid == 5 || mapid == 12 || mapid == 18)) {
            return false;
