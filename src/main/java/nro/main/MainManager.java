...
//                System.err.print(i);
            ...
            res = SQLManager.stat.executeQuery("SELECT * FROM `clan_member`;");
                ...
                Util.log("Load Members thành công (" + members.size() + ")");
                res.close();
        ...
        //SQLManager.close();
        SQLManager.create(MainManager.mysql_host, MainManager.mysql_port, MainManager.mysql_database, MainManager.mysql_user, MainManager.mysql_pass);
    }
